...
* Modified cmdlet `Set-AzVirtualNetworkGatewayConnection`
   - Added parameters `-AuthenticationType`, `-CertificateAuthentication`
* Added cmdlet `New-AzVirtualNetworkGatewayCertificateAuthentication`#### Az.SignalR 2.3.0 
, `Add-AzSignalRNetworkIpRule`, `Get-AzSignalRReplica`, `New-AzSignalRNetworkIpRuleObject`, `New-AzSignalRReplica`, `Remove-AzSignalRNetworkIpRule`, `Remove-AzSignalRReplica`, `Restart-AzSignalRReplica`, `Start-AzSignalRReplica`, `Stop-AzSignalRReplica`, `Update-AzSignalRReplica`
